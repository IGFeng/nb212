...
@section('content')
    @include('validator')
        ...
        <div id="add-form-textarea"><label for="content">内容:</label><textarea id="content" name="message[content]" cols="70" rows="9" placeholder="“我喝过很烈的酒，也放过不该放的手，从前不会回头，往后不会将就。”"></textarea></div>
